...
// const EstuaryHost = process.env.API_HOST || 'http://localhost:3004';

// /**
//  * Our provider options for the wallets we support.
//  */
// export const web3ModalConfig = {
//   network: process.env.ETH_CHAIN_NAME, // optional
...
//  * @param ens='' The ENS to use to retrieve the API key.
...
//   const nonce = await getNonce(host);
//   if (!nonce) {
...
// /**
//  * @description Attempt to get the nonce from an Estuary host.
//  * @returns {string} - The nonce.
//  */
// async function getNonce(host: string): Promise<string> {
...
//       } else {
//         console.log(
//           'Error authenticating against Estuary: Bad status code: ',
//           res.status
//         );
//         return '';
//       }
